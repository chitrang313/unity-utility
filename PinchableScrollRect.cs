...
namespace ViitorCloud.Soreal {
    public class PinchableScrollRect : ScrollRect {
        ...
        [SerializeField] float _zoomLerpSpeed = 2f;
        ...
        void OnPinchStart() {
            ...
            _startPinchScreenPosition = (pos1 + pos2) / 2f;
            _startPinchDist = Distance(pos1, pos2) * _startPinchScreenPosition.x;
        ...
        void OnPinch() {
            ...
            Vector2 centerOfTouch = ((pos1 + pos2) / 2f);
            float currentPinchDist = Distance(pos1, pos2) * centerOfTouch.x;
